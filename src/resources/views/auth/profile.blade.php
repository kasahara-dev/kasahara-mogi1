    ...
    <div class="form-area">
        ...
        <form class="form" action="/mypage/profile" method="post">
            ...
            <dl class="form-dl">
                ...
                <dt class="form-dt">郵便番号</dt>
                <dd class="form-dd"><input type="text" name="post-number" class="form-input"
                        value="{{ old('post-number') }}" /></dd>
                <dd class="form-error">@error('post-number'){{ $message }}@enderror</dd>
                <dt class="form-dt">住所</dt>
                <dd class="form-dd"><input type="text" name="address" class="form-input" value="{{ old('address') }}" />
                </dd>
                <dd class="form-error">@error('address'){{ $message }}@enderror</dd>
                <dt class="form-dt">ビル名</dt>
                <dd class="form-dd"><input type="text" name="building" class="form-input" value="{{ old('building') }}" />
                </dd>
                <dd class="form-error">@error('building'){{ $message }}@enderror</dd>
            </dl>
