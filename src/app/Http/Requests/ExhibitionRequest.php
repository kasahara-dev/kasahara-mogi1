...
class ExhibitionRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'item_img_input' => ['required', 'mimetypes:image/jpeg,image/png', new ImgFileName()],
            'category' => ['required'],
            'condition' => ['required'],
    ...
    public function messages()
    {
        return [
            ...
            'item_img_input.required' => '商品画像を選択してください',
            'item_img_input.mimetypes' => '拡張子が.jpegもしくは.pngの画像を選択してください',
